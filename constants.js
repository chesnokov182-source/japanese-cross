...
// Генерация удвоенных согласных (например "kka" → ッカ)
...
// Ключи хранилища
export const STORAGE_PROGRESS_KEY = "crosswordProgress";
export const STORAGE_COMPLETED_KEY = "completedCrosswords";
export const STORAGE_UNLOCKED_KEY = "unlockedCrosswords";
export const STORAGE_EARNED_KEY = "earnedPoints";
export const STORAGE_GAME_KEY = "gameStats";
export const STORAGE_SKINS_KEY = "skins";
export const STORAGE_LAST_LEVEL = "lastPlayedLevel";
export const STORAGE_LAST_PUZZLE = "lastPlayedPuzzle";
