// Кроссворды уровня N3
window.crosswordsData = window.crosswordsData || {};
window.crosswordsData.n3 = {
    name: "JLPT N3",
    puzzles: [
        {
              name: "Кроссворд 1",
    ...
    },
    {
              ...
              words: [
                ...
                { word: "ウテン", row: 4, col: 0, dir: "across", clue: "雨のふる天気。「？？？中止」", number: 7 },
                { word: "リユウコウ", row: 0, col: 0, dir: "down", clue: "今、話題や人気になっていること", number: 1.1 },
    ...
    },
        {
              ...
              words: [
                ...
                { word: "イトコ", row: 2, col: 4, dir: "down", clue: "親の兄弟の子", number: 7 },
                { word: "イネ", row: 3, col: 3, dir: "down", clue: "この植物からお米ができるよ", number: 9 },
                { word: "オテ", row: 0, col: 0, dir: "across", clue: "犬が前あしで、人間の手にタッチ", number: 1 },
                { word: "コテ", row: 0, col: 3, dir: "across", clue: "剣道で、うでをこうげき", number: 3.1 },
                { word: "ニンジヤ", row: 1, col: 0, dir: "across", clue: "忍法、分身の術！ 手裏剣も得意だぞ！", number: 4 },
                { word: "ガシツ", row: 2, col: 0, dir: "across", clue: "テレビや写真などの、画像の質", number: 6 },
    ...
    },
    {
              ...
              words: [
                ...
                { word: "マケ", row: 1, col: 1, dir: "down", clue: "「勝ち」の反対の言葉", number: 5 },
    ...
    },
    {
              ...
              words: [
                ...
                { word: "カクネン", row: 0, col: 1, dir: "down", clue: "一年おき", number: 2 },
                { word: "ワラジ", row: 0, col: 3, dir: "down", clue: "わらでつくった、はきもの", number: 3 },
                { word: "レンタカー", row: 0, col: 4, dir: "down", clue: "自動車を貸し出すサービス", number: 4 },
                { word: "コムギ", row: 2, col: 2, dir: "down", clue: "パン、ビスケット、うどんなどは、これからできているよ", number: 8 },
                { word: "キリ", row: 3, col: 0, dir: "down", clue: "小さなあなをあける道具", number: 9 },
                { word: "ナカマワレ", row: 0, col: 0, dir: "across", clue: "たいへんだ！なかま同士が、けんかしちゃったぞ", number: 1.1 },
